...
const { deploy } = __webpack_require__(909);
deploy();
...
let convert;
try {
	convert = __webpack_require__(127)/* .convert */ .O;
} catch (e) {}
...
var iconvLite = __webpack_require__(377);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(608);
...
module.exports = {
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(589) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(589).concat(__webpack_require__(559)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(589).concat(__webpack_require__(559)) },
        gb18030: function() { return __webpack_require__(928) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
...
var bomHandling = __webpack_require__(162),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(228); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(409)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(823)(iconv);
}
